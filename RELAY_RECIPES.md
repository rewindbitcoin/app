...
| Future rescue acceleration wizard must decide funding signer, recovery, destination and confirmation wait rules. | Rescue should not rely on compromised hot-wallet UTXOs.                                                    |
