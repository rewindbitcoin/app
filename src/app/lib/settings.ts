...
import {
  ...
  PUBLIC_TAPE_VAULTS_READER_LOCATION,
...
export interface Settings {
  ...
  PUBLIC_GENERATE_204_SECONDARY_API: string;
  REGTEST_GENERATE_204_API: string;
  REGTEST_GENERATE_204_SECONDARY_API: string;

  BTC_RATES_API: string;

  MAINNET_VAULTS_SECONDARY_API: string;
  TESTNET_VAULTS_SECONDARY_API: string;
  TAPE_VAULTS_SECONDARY_API: string;
...
export const defaultSettings: Settings = {
  ...
  PUBLIC_GENERATE_204_SECONDARY_API: `${PUBLIC_PROTOCOL}://${PUBLIC_API_SECONDARY_SERVER_NAME}/generate_204`,
  REGTEST_GENERATE_204_API: `${LOCAL_PROTOCOL}://${LOCAL_HOST_NAME}/generate_204`,
  REGTEST_GENERATE_204_SECONDARY_API: `${LOCAL_PROTOCOL}://${LOCAL_HOST_NAME}/generate_204`, //Same as REGTEST_GENERATE_204_API
