...
import {
  ...
  PUBLIC_REWINDNET_VAULTS_READER_LOCATION,
  PUBLIC_REWINDNET_SERVER_NAME,
  PUBLIC_REWINDNET_WEB_LOCATION,
  LOCAL_REGTEST_WEB_PORT,
  PUBLIC_REWINDNET_ESPLORA_API_LOCATION,
  PUBLIC_REWINDNET_BLOCK_EXPLORER_LOCATION,
...
export const defaultSettings: Settings = {
  ...
  REWINDNET_SERVICE_ADDRESS_API: `${PUBLIC_PROTOCOL}://${PUBLIC_API_SERVER_NAME}${PUBLIC_REWINDNET_SERVICE_ADDRESS_LOCATION}`,
  ...
  REWINDNET_VAULTS_API: `${PUBLIC_PROTOCOL}://${PUBLIC_API_SERVER_NAME}${PUBLIC_REWINDNET_VAULTS_WRITER_LOCATION}`,
  ...
  REWINDNET_VAULTS_SECONDARY_API: `${PUBLIC_PROTOCOL}://${PUBLIC_API_SECONDARY_SERVER_NAME}${PUBLIC_REWINDNET_VAULTS_READER_LOCATION}`,
  ...
  REWINDNET_ESPLORA_API: `${PUBLIC_PROTOCOL}://${PUBLIC_REWINDNET_SERVER_NAME}${PUBLIC_REWINDNET_ESPLORA_API_LOCATION}`,
  ...
  REWINDNET_BLOCK_EXPLORER: `${PUBLIC_PROTOCOL}://${PUBLIC_REWINDNET_SERVER_NAME}${PUBLIC_REWINDNET_BLOCK_EXPLORER_LOCATION}`,
  REGTEST_BLOCK_EXPLORER: `${LOCAL_PROTOCOL}://${LOCAL_HOST_NAME}:${LOCAL_REGTEST_BLOCK_EXPLORER_PORT}`,

  //RewindNet Web Server (the faucet entry point + web server with service description)
  REWINDNET_WEB_SERVER: `${PUBLIC_PROTOCOL}://${PUBLIC_REWINDNET_SERVER_NAME}${PUBLIC_REWINDNET_WEB_LOCATION}`,
