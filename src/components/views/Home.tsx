...
//
//  TODO: upgrade to expo 50:
//  https://docs.expo.dev/workflow/upgrading-expo-sdk-walkthrough/
//
//  TODO: Don't use modals but navigation...
//  expo is using reactnavigation internally:
...
//     -> Also using react-navigation modals are included in navigation: https://reactnavigation.org/docs/modal
//
...
import VaultSetUp from '../../components/views/VaultSetUp';
import VaultCreate from '../../components/views/VaultCreate';
import Unvault from '../../components/views/Unvault';
  ...
  return (
    ...
    >
      ...
      >
        {discovery && mnemonic && (
          <MBButton
            title={checkingBalance ? 'Refreshing Balance…' : 'Refresh Balance'}
                ...
                return (
                  <View key={vaultAddress} style={styles.vaultContainer}>
                    ...
                    {vault.triggerPushTime ? (
                      ...
                      <Text>
                        Locked On:{' '}
                        {new Date(vault.vaultPushTime * 1000).toLocaleString()}
                      </Text>
                    )}
                    <Text>
                      {!vault.triggerTxHex
